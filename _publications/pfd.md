...
We will learn all the methods to do such integral. In the whole section, we will assume that $\displaystyle{f(x) = 
\frac{P(x)}{Q(x)}}$
...
\end{align*}
We call this \textbf{Systems of Linear Equations} of $n$ unknowns ($x_1,x_2 \cdots x_n$), where $a_{ij}$ are coefficients, and 
...
\begin{bmatrix}
1 & &a_{12} & &a_{13} &\vline &b_1\\
0 & &a_{22} & &a_{23} &\vline &b_2\\
0 & &a_{32} & &a_{33} &\vline &b_3
\end{bmatrix}
$$
...
\begin{bmatrix}
1 & &0 & &0 &\vline &\displaystyle{\frac{1}{2}}\\
0 & &1 & &0 &\vline &\displaystyle{\frac{1}{5}}\\
0 & &0 & &1 &\vline &\displaystyle{-\frac{1}{10}}
\end{bmatrix}
$$
